...
import { images, AppRequired, FONTS } from '../../constants';

const slides = [
  {
    key: 1,
    title: 'Title 1',
    text: " تحتاج الي استشاره طبيب نفسي ",
  ...
  },
  {
    key: 2,
    title: 'Title 2',
    text: " تحتاج لتسجيل ما تقوم بكتابته",
  ...
  },
  {
    key: 3,
    title: 'Rocket guy',
    text: " تحتاج لتعليم طفلك ",
    image: images.intro_3,
    backgroundColor: '#22bcb5',
  }, {
    key: 4,
    title: 'Rocket guy',
    text: " قدم الدعم لنفسك و قم بتسجيل معنا في هذا التطبيق",
